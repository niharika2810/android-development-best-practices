...
Split your app module into different small modules, and give those modules as dependency to requried modules like _(implementation project(":network-module"))_ , you will get benifit of faster builds while developing your app and reusable code. Later you can extend this to proide dynamic delivery module.
